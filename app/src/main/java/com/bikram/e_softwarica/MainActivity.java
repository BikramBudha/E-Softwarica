...
import com.bikram.e_softwarica.models.LocalUser;
import com.bikram.e_softwarica.models.User;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        ;
        user.setUsername("Bikram");
        user.setPassword("170049");
        users.add(user);
